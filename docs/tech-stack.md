<!-- =========================================================
     기술 스택 페이지
     - 로고 나열보다 "왜 선택했고 어디에 쓰는지"가 핵심입니다.
     - 숙련도를 과장하지 마세요. 직접 다뤄본 범위만 적습니다.
     - 아래 표의 각 행을 본인 기술로 교체/추가/삭제하세요.
     ========================================================= -->
...
<!-- TODO: 필요하면 섹션을 더 추가하세요.
     예) ## 프런트엔드 / ## 모니터링·관측성 / ## 협업 도구 -->
...
!!! note "기술 선택 철학"
    새 기술 도입 시 스스로에게 묻는 세 가지 질문:

    1. 지금 겪는 **문제를 실제로 해결**하는가?
    2. 팀이 **유지보수**할 수 있는가?
    3. 더 단순한 대안은 정말 없는가?

    <!-- TODO: 위 철학을 본인 생각으로 바꾸거나, 불필요하면 이 블록을 삭제하세요. -->
