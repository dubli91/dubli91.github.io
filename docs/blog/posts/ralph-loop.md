...
<video controls width="100%">
  <source src="images/250717/play_optimized.mp4" type="video/mp4">
...
![Answer](images/250717/2.png)

질의응답이 끝나면 specs폴더에 md파일들이 생성됩니다. 아래는 개요 파일의 예시입니다.

![Overview](images/250717/3.png)
